...
public class MolecraftEntities {
    ...
    public static final MolecraftEntity MASTER_MODE_FLOOR_FOUR = register(new MolecraftEntity("master_mode_floor_four", Component.literal("Master Mode Floor Four"), MasterModeFloorFour::new, true));
    public static final MolecraftEntity HEALTH_DISPLAY = register(new MolecraftEntity("health_display", Component.literal("Health Display"), HealthDisplay::new, false));
